                ...
                <li class="nav-item dropdown dropdown-authentication">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <form @submit.prevent="logout">
                            <a class="dropdown-item" @click="logout" href="#"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
                        </form>
                    </div>
                </li>
            </ul>
            ...
            <footer class="footer">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <p>Powered by<a href="https://tagsncode.co/" class="text-dark" target="_blank">Tagsncode</a> © 2021</p>
                    </div>
                    <div class="col-md-6 col-sm-12">
